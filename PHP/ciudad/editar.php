        ...
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"  id="fciudad">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="nombre_ciudad">Nombre ciudad:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nombre_ciudad" name="nombre_ciudad" placeholder="Ingrese Nombre del ciudad"
                            value = "">
                        </div>
                    </div>
