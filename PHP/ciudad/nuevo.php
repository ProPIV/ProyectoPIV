...
<div id="seccion-ciudad">
	<div class="box-header">
    	<i class="fa fa-building" aria-hidden="true">Gestión de las ciudades </i>
        <!-- tools box -->
        ...
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"  id="fciudad">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="nombre_ciudad">Nombre de ciudad:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nombre_ciudad" name="nombre_ciudad" placeholder="Ingrese Nombre de ciudad"
                            value = "">
                        </div>
                    </div>
