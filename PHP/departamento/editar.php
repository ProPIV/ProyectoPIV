<div id="seccion-departamento">
    <div class="box-header">
    	<i class="fa fa-building" aria-hidden="true">Gestion de departamentos</i>
        ...
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"  id="fdepartamento">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="nombre_departamento">Nombre Departamento:</label>
                        <div class="col-sm-10">
