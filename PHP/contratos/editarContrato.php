   <div id="seccion-contrato">
    <div class="box-header">
    	<i class="fa fa-building" aria-hidden="true">Gestion de contrato</i>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="actualizar" data-toggle="tooltip" title="Actualizar contrato" class="btn btn-primary">Actualizar</button>
