...
function Header()
{
    ...
    $this->Cell(60);
    // T�tulo
    $this->Cell(30,10,'Reporte de Procesos',0,'C',0);
    // Salto de l�nea
    $this->Ln(20);


    $this->Cell(50,10,'Id Proceso',1,0,'C',0);
    $this->Cell(80,10,'Nombre Proceso',1,0,'C',0);
...
while($row =$resultado->fetch_assoc()){
    $pdf->Cell(50,10,$row['id_proceso'],1,0,'C',0);
    $pdf->Cell(80,10,$row['nombre_proceso'],1,0,'C',0);
